...
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 作成日     | 2026-07-16                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 最終更新   | 2026-07-28（**v0.17.0 = B-21**（`declarationRisks`）+ `verify:published` スクリプト新設。**公開版 0.16.0 の受入検証はホストで 37/37 PASS**。v0.17.0 はホストの typecheck / test / check 待ち）（2026-07-27: **v0.16.0 = B-16 + B-20**。B-16 = create 系 3 ツールの `pdfVersion: '2.0'`。B-20 = `ensure_pdfa(flavour: 'pdfa-4' | 'pdfa-4f')` で **veraPDF 109/109 COMPLIANT**。回帰 = PDF/A-3b 146/146・PDF/UA-1 106/106。**specs/16 第一段階は完了**（T2 残件 7 件を B-20 の項に記録）。ホストのテスト待ち） |
...
### 0-c. W-6 = v0.15.2 候補（2026-07-26 実装・**リリース待ち**）
